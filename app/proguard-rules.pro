...
# in D:\android-sdk_r24.1.2-windows\android-sdk_r24.1.2-windows\android-sdk-windows/tools/proguard/proguard-android.txt
...
#---------------------------------1.实体类---------------------------------
-keep com.clean.flyjiang.cleanbaseapp.bean.** { *; }
