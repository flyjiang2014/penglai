 ...
 * 文件说明：
 */
public class BannerRound extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public BannerRound(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BannerRound isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerRound setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerRound setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerRound setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerRound setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerRound setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerRound setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerRound setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerRound setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerRound setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerRound setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public BannerRound setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BannerRound setOnBannerListener(OnBannerListener listener) {
